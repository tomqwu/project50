...
export async function resetDb(): Promise<void> {
  await prisma.$executeRawUnsafe(
    `TRUNCATE TABLE "User","Identity","Follow","Block","Report","Challenge","Activity","ActivityMedia","DayStatus","Reaction","Milestone","Recap","RuleCheck","Project50DayMedia","DayJournal","Subscription","Referral","MagicLinkToken" RESTART IDENTITY CASCADE;`,
  );
  _userCounter = 0;
}
