...
export async function resetDb(): Promise<void> {
  await prisma.$executeRawUnsafe(
    `TRUNCATE TABLE "User","Identity","Follow","Block","Report","Challenge","Activity","ActivityMedia","DayStatus","Reaction","Milestone","Recap","RuleCheck","Subscription" RESTART IDENTITY CASCADE;`,
  );
  _userCounter = 0;
}
